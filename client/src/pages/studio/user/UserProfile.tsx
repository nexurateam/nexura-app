...
useEffect(() => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await apiRequest<{ hub: any }>({
        method: "PATCH",
        endpoint: "/user-hub/update-profile",
        formData: fd,
      });
      ...
      const updatedUser = {
        ...currentUser,
        username: res.hub?.name || name.trim(),
        bio: res.hub?.description || bio || "",
        avatar: res.hub?.logo || imagePreview || currentUser?.avatar || "",
      };
